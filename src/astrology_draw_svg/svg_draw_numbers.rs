    ...
    match minute {
        ...
        6 => {
            ...
            let data1 = Data::new()
                ...
                .cubic_curve_by((-0.2, 0.4, -0.4, 0.9, -0.4, 1.5)) // c
                .cubic_curve_by((0.1, 4.1, 2.0, 7.2, 5.5, 7.2)) // c
                .cubic_curve_to((25.6, 37.0, 27.5, 34.6, 27.5, 31.0)) // C
                .close(); // z
            let data2 = Data::new()
                .move_to((39.4, 12.7)) // M
                .cubic_curve_by((-0.9, 3.2, -2.5, 7.4, -3.6, 9.2)) // c
        ...
        9 => {
            ...
            let data1 = Data::new()
                ...
                .cubic_curve_by((0.2, -0.3, 0.3, -0.7, 0.3, -1.2)) // c
                .cubic_curve_by((0.0, -4.3, -1.6, -7.6, -5.1, -7.6)) // c
                .cubic_curve_to((19.4, 16.2, 17.4, 18.8, 17.4, 22.4)) // C
                .close(); // z
            let data2 = Data::new()
                .move_to((39.4, 12.7)) // M
                .cubic_curve_by((-0.9, 3.2, -2.5, 7.4, -3.6, 9.2)) // c
        ...
        10 => {
            ...
            let data2 = Data::new()
                ...
                .cubic_curve_by((-4.9, 0.0, -8.2, -4.6, -8.3, -12.9)) // c
                .cubic_curve_by((0.0, -8.4, 3.6, -13.1, 8.7, -13.1)) // c
                .cubic_curve_to((36.8, 14.7, 39.8, 19.4, 39.8, 27.4)) // C
                .close() // z
                .move_to((26.1, 27.8)) // M
                .cubic_curve_by((0.0, 6.5, 2.0, 10.2, 5.1, 10.2)) // c
                .cubic_curve_by((3.5, 0.0, 5.1, -4.1, 5.1, -10.5)) // c
                .cubic_curve_by((0.0, -6.2, -1.6, -10.2, -5.1, -10.2)) // c
                .cubic_curve_to((28.3, 17.3, 26.1, 20.9, 26.1, 27.8)) // C
                .close(); // z
            let data3 = Data::new()
                .move_to((48.3, 13.7)) // M
        ...
        16 => {
            ...
            let data2 = Data::new()
                ...
                .cubic_curve_by((-0.2, 0.4, -0.4, 0.9, -0.4, 1.5)) // c
                .cubic_curve_by((0.1, 4.1, 2.0, 7.2, 5.5, 7.2)) // c
                .cubic_curve_to((34.5, 38.0, 36.5, 35.6, 36.5, 32.0)) // C
                .close(); // z
            let data3 = Data::new()
                .move_to((48.3, 13.7)) // M
                .cubic_curve_by((-0.9, 3.2, -2.6, 7.4, -3.6, 9.2)) // c
        ...
        18 => {
            ...
            let data2 = Data::new()
                ...
                .cubic_curve_by((3.1, 1.2, 5.1, 3.4, 5.1, 6.5)) // c
                .cubic_curve_by((0.0, 4.4, -3.7, 7.3, -8.5, 7.3)) // c
                .cubic_curve_to((25.9, 40.6, 22.8, 37.5, 22.8, 33.8)) // C
                .close() // z
                .move_to((36.3, 33.7))
                .cubic_curve_by((0.0, -3.1, -2.1, -4.5, -5.5, -5.5)) // c
                .cubic_curve_by((-2.9, 0.8, -4.5, 2.8, -4.5, 5.2)) // c
                .cubic_curve_by((-0.1, 2.6, 1.8, 4.8, 5.0, 4.8)) // c
                .cubic_curve_to((34.3, 38.1, 36.3, 36.3, 36.3, 33.7)) // C
                .close() // z
                .move_to((27.0, 21.1)) // M
                .cubic_curve_by((0.0, 2.5, 1.9, 3.9, 4.8, 4.6)) // c
                .cubic_curve_by((2.2, -0.7, 3.8, -2.3, 3.8, -4.6)) // c
                .cubic_curve_by((0.0, -2.0, -1.2, -4.1, -4.2, -4.1)) // c
                .cubic_curve_to((28.5, 17.1, 27.0, 18.9, 27.0, 21.1)) // C
                .close(); // z
            let data3 = Data::new()
                .move_to((48.3, 13.7)) // M
                .cubic_curve_by((-0.9, 3.2, -2.6, 7.4, -3.6, 9.2)) // c
        ...
        19 => {
            ...
            let data2 = Data::new()
                ...
                .cubic_curve_by((0.2, -0.3, 0.3, -0.7, 0.3, -1.2)) // c
                .cubic_curve_by((0.0, -4.3, -1.6, -7.6, -5.1, -7.6)) // c
                .cubic_curve_to((28.3, 17.2, 26.3, 19.8, 26.3, 23.4)) // C
                .close(); // z
            let data3 = Data::new()
                .move_to((48.3, 13.7)) // M
                .cubic_curve_by((-0.9, 3.2, -2.6, 7.4, -3.6, 9.2)) // c
